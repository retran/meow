...
# lib/core/strings.sh - Centralized UI strings for localization
...
# ============================================================================
# STATIC MESSAGES - Simple strings without parameters
# ============================================================================
...
parse_spinner_messages() {
  ...
  SPINNER_PROGRESS="$progress_msg"
  SPINNER_SUCCESS="$success_msg"
  SPINNER_FAIL="$fail_msg"
}
