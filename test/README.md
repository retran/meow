...
```
test/unit/
├── core/           # Tests for lib/core/*.sh (9 files, 120 tests)
├── env/            # Tests for lib/env/*.sh (1 file, 12 tests)
├── motd/           # Tests for lib/motd/*.sh (1 file, 18 tests)
└── symlinks/       # Tests for lib/symlinks/*.sh (1 file, 15 tests)
```
