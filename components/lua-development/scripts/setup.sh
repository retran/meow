...
if ! command -v lua >/dev/null 2>&1; then
  ui_warning "TODO: write message - lua_dev_lua_not_found_skip"
  exit 0
fi

ui_action_start "TODO: write message - lua_dev_configuring"

if command -v luarocks >/dev/null 2>&1; then
  ui_info "TODO: write message - lua_dev_configuring_luarocks"
...
EOF
  ...
  ui_info "TODO: write message - lua_dev_installing_essential_rocks"
...
if command -v lua-language-server >/dev/null 2>&1; then
  ui_info "TODO: write message - lua_dev_configuring_language_server"
...
ui_action_success "TODO: write message - lua_dev_configured_successfully"
