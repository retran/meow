...
ui_info "$(get_static_message "docker_cli_setup_running")"
...
ui_info "$(get_static_message "docker_cli_checking_host_socket")"
...
ui_info "$(get_static_message "docker_cli_configuring_context")"
...
ui_info "$(get_static_message "docker_cli_testing_connection")"

if docker version >/dev/null 2>&1; then
  ui_success "$(get_static_message "docker_cli_setup_completed")"
  ui_info "$(get_static_message "docker_cli_ready_to_use")"
else
