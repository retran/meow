...
ui_action_start "$(get_static_message "corporate_configuring")"

if [[ -d "/Applications/Slack.app" ]]; then
  ui_info "$(get_static_message "corporate_configuring_slack")"
...
if [[ -d "/Applications/zoom.us.app" ]]; then
  ui_info "$(get_static_message "corporate_configuring_zoom")"
...
ui_action_success "$(get_static_message "corporate_configured_successfully")"
