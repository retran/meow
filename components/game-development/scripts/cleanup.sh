...
if [[ -d "$HOME/Library/Application Support/krita" ]]; then
  ui_info "$(get_static_message "game_dev_cleaning_krita_cache")"
...
ui_success "$(get_static_message "game_dev_cleanup_completed")"
