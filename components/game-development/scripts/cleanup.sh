...
if [[ -d "$HOME/Library/Application Support/krita" ]]; then
  ui_info "TODO: write message - game_dev_cleaning_krita_cache"
...
ui_success "TODO: write message - game_dev_cleanup_completed"
