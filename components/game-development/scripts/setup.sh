...
ui_action_start "$(get_static_message "game_dev_configuring")"

if [[ -d "/Applications/Blender.app" ]]; then
  ui_info "$(get_static_message "game_dev_configuring_blender")"
...
if [[ -d "/Applications/krita.app" ]]; then
  ui_info "$(get_static_message "game_dev_configuring_krita")"
...
ui_action_success "$(get_static_message "game_dev_configured_successfully")"
